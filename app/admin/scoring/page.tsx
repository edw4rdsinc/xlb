...
export default function AdminScoringPage() {
  ...
  async function handleSyncStats() {
    setSyncing(true);
    try {
      // Fetch stats from API (mock for now)
      ...
      alert(`Successfully synced stats for Week ${selectedWeek}!\n\n` +
            ...
            `(Mock data for testing - connect real API later)`);
    } catch (error: any) {
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start">
            ...
            <div className="text-sm text-blue-800">
              ...
              <p>Currently using mock data for testing. To connect a real NFL stats API:</p>
              <ol className="list-decimal list-inside mt-2 space-y-1">
                <li>Sign up for an NFL stats API (ESPN, Sleeper, RapidAPI, etc.)</li>
                <li>Update <code className="bg-blue-100 px-1 rounded">lib/api/nfl-stats.ts</code> with real API calls</li>
