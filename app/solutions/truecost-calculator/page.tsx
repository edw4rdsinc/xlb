...
import FIECalculator from '@/components/tools/FIECalculator'
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center">
              <div className="md:col-span-1 text-center">
                ...
                <div className="flex justify-center gap-4">
                  <a
                    href="https://www.linkedin.com/in/daron-pitts-csfs-60482033/"
                    target="_blank"
                  ...
                  <a
                    href="mailto:daron@xlbenefits.com"
                    className="text-white/80 hover:text-white transition-colors"
              ...
              <div className="md:col-span-2">
                <h2 className="text-3xl font-bold text-white mb-2">Daron Pitts, CSFS</h2>
                <p className="text-xl-bright-blue font-semibold mb-4">President & Founder</p>
                <div className="text-white/90 leading-relaxed space-y-3">
                  <p>
                    Daron founded XL Benefits in July 2014 with a mission to bring uncommon service and creative
                    problem-solving to the medical stop-loss industry. With over 12 years of specialized experience,
                    he holds the Certified Self-Funding Specialist (CSFS) designation.
                  </p>
                  <p>
                    His expertise spans complex rate analysis, multi-carrier RFP management, and helping brokers
                    navigate challenging placements. Daron works primarily with insurance brokers and TPAs across
                    the country, providing the technical depth and carrier relationships needed to serve self-funded groups.
                  </p>
                  <p>
                    When not working on stop-loss solutions, Daron enjoys watching sports, listening to audiobooks,
                    playing board games, and spending time with his three children.
                  </p>
                </div>
              </div>
            </div>
