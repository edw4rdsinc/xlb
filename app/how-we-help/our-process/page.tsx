          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <AnimatedSection animation="fade-up">
              <div className="bg-white rounded-lg p-8 shadow-md">
                ...
                <div className="space-y-3">
                  <div className="flex items-start"><svg className="w-5 h-5 text-xl-bright-blue mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg><div><span className="font-semibold text-xl-dark-blue">SPD: Eligibility Review</span><span className="text-xl-grey"> - Verification of accurate eligibility provisions</span></div></div>
                  ...
                  <div className="flex items-start"><svg className="w-5 h-5 text-xl-bright-blue mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg><div><span className="font-semibold text-xl-dark-blue">Extraneous Personnel Policies/Procedures</span><span className="text-xl-grey"> - Removal of non-benefits language that creates confusion</span></div></div>
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection animation="fade-up">
              <div className="bg-white rounded-lg p-8 shadow-md">
                ...
                <div className="space-y-3">
                  <div className="flex items-start"><svg className="w-5 h-5 text-xl-bright-blue mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg><div><span className="font-semibold text-xl-dark-blue">PPO Evaluation</span><span className="text-xl-grey"> - Network adequacy, discount performance, and repricing accuracy</span></div></div>
            ...
            <AnimatedSection animation="fade-up">
              <div className="bg-white rounded-lg p-8 shadow-md">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start"><svg className="w-5 h-5 text-xl-bright-blue mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg><div><span className="font-semibold text-xl-dark-blue">Illustrative COBRA Rates</span><span className="text-xl-grey"> - Accurate COBRA premium calculations</span></div></div>
                  ...
                  <div className="flex items-start"><svg className="w-5 h-5 text-xl-bright-blue mr-3 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg><div><span className="font-semibold text-xl-dark-blue">Plan Participation</span><span className="text-xl-grey"> - Employee enrollment and contribution analysis</span></div></div>
