          ...
          {(email || linkedinUrl) && (
            <div className="relative z-10 mt-4 flex gap-3 justify-center">
              {email && (
                <a
                  href={`mailto:${email}`}
                  className="inline-flex items-center justify-center text-white hover:text-white/90 transition-all bg-white/10 hover:bg-white/20 hover:scale-110 w-12 h-12 rounded-full"
