    ...
    return (
      <div className="max-w-4xl mx-auto p-6 space-y-8">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-6 border border-blue-200">
          <h3 className="text-xl font-bold text-xl-dark-blue mb-3 text-center">Share Your Results</h3>
          <p className="text-sm text-xl-grey text-center mb-4">
            Share this assessment with your network to help other brokers evaluate self-funding readiness
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            <button
              onClick={() => {
                const shareText = `I just completed the Self-Funding Readiness Assessment from XL Benefits! My client scored ${readinessPercentage}% - ${readinessLabels[readinessLevel]}.

Find out if your clients are ready for self-funding:`;
                const shareUrl = `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://xlbenefits.com/solutions/self-funding-feasibility')}&summary=${encodeURIComponent(shareText)}`;
            ...
            <button
              onClick={() => {
                const url = 'https://xlbenefits.com/solutions/self-funding-feasibility';
